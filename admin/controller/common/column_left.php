	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($sale) {
				...
				if ($this->user->hasPermission('access', 'extension/module/serial_number')) {
					$order_fulfillment[] = array(
						'name'	   => $this->language->get('text_find_order_by_id'),
				...
				if ($this->user->hasPermission('access', 'extension/module/serial_number')) {
					$order_fulfillment[] = array(
						'name'	   => $this->language->get('text_find_order_by_serial'),
				...
				if ($order_fulfillment) {
					$data['menus'][] = array(
						'id'       => 'menu-design',
						'icon'	   => 'fa-first-order', 
						'name'	   => $this->language->get('text_order_fulfillment'),
						'href'     => '',
						'children' => $order_fulfillment
					);	
				}	
