	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . $url, true)
				...
				$data['add_serials'] = $this->url->link('extension/module/serial_number/addProductSerials', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'require_serial'=> $result['require_serial'],
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_store'])) {
			...
			$data['product_store'] = array(0);
				...
				if (isset($this->request->post['require_serial'])) {
					$data['require_serial'] = $this->request->post['require_serial'];
				} elseif (!empty($product_info)) {
					$data['require_serial'] = $product_info['require_serial'];
				} else {
					$data['require_serial'] = 1;
				}
